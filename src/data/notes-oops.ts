...
export const notesOops: TopicNote = {
  topic: "oops",
  title: "OOP — simple notes",
  blurb:
    "We explain OOP like class notes a Class-10 student can read: pictures of a rubber stamp, a locker with a key, a family surname, and the word “play”. Then we solve five tiny examples in each topic, one object or one print at a time.",
  blocks: [
    {
      heading: "What are the four pillars?",
      body: "A class is a rubber stamp. You press it to make objects, the same way a stamp makes many copies of one picture. Encapsulation is a locker with a key: the stuff sits inside, and you only change it with the key (methods). Inheritance is a child who gets the family surname: the child is a kind of parent and already has the family tools. Polymorphism is the word “play”: a child, a musician, and a film can all “play”, but each does something different.\n\nThe exam names four pillars. Abstraction shows the useful face and hides how the work is done — you cannot new an abstract class or a Java interface. Encapsulation keeps data private; a public field is not encapsulated even if a getter exists. Inheritance is IS-A: Child c = new Child() so Parent p = c is legal. A Car that has an Engine field is HAS-A, not IS-A. Polymorphism is one name, many behaviours: overload at compile time, override at run time.",
      howTo: [
        ...
        "If the code says new AbstractType(), that is a compile error. You cannot press a blank stamp.",
        "If a child reads a private parent field, that is a compile error. The locker key stays with the parent.",
        "If Parent p = new Child() compiles, that is inheritance (IS-A).",
        "A public field is not a locker, even if a getter sits next to it.",
      ],
      bullets: [
        "A class is a stamp. An object is one press of that stamp.",
        ...
        "Inheritance: Child IS-A Parent. A field is HAS-A, not a surname.",
    ...
    System.out.print(x.area() + x.tag());
          ...
          steps: [
            ...
            },
            {
              ...
              why: "You program to the useful face. The real object fills in area().",
            },
            {
              do: "x.area() runs Square’s 3*3 = 9. x.tag() runs the inherited 1. print 10.",
              why: "The child writes area(). The parent’s ready method tag() is reused.",
            },
            {
          ...
          steps: [
            {
              ...
              why: "Encapsulation is a locker. private is the key, and only P holds it.",
            },
            {
              do: "C.leak() writes return x. C is a child, but private is not a name the child may use.",
            ...
            },
            {
              ...
              why: "The child’s direct use of x breaks the locker, so javac stops it.",
            },
          ],
...
class Main {
  public static void main(String[] args) {
    ...
    System.out.print((a instanceof Dog) + " " + (a instanceof Animal));
          ...
          steps: [
            {
              do: "Dog extends Animal, so a dog IS an animal. Animal a = new Dog() is legal.",
              why: "Inheritance is the family surname. A child may sit in a parent variable.",
            },
            {
            ...
            {
              do: "A car HAS an engine (a field). Engine e = c does not compile.",
              why: "A field is a pencil box in a bag, not a surname. Car is not an Engine.",
            },
            {
...
class Main {
    ...
    System.out.print(p.pay());
          ...
          steps: [
            ...
            },
            {
              ...
              why: "You cannot press a blank stamp. You construct a class that implements it.",
            },
            {
  ...
  int getN() { return n; }
          ...
          steps: [
            {
              ...
              why: "Encapsulation needs the data hidden. public is an open window, not a locker.",
            },
            {
            ...
            },
            {
              ...
              why: "Methods become the only legal path — the key to the locker.",
            },
            {
    ...
    {
      heading: "What is compile-time vs runtime polymorphism?",
      body: "Polymorphism is the word “play”. On a sports field, “play” means a game. On a stage, “play” means a drama. On a phone, “play” means a song. One word, different work. In code, one method name can also do different work.\n\nThe exam splits two times. Compile-time polymorphism is overloading: several methods share a name and differ by parameters. The compiler picks one using the variable’s type and the argument types. Runtime polymorphism is overriding: a child rewrites a parent instance method with the same signature. Java instance methods are virtual, so the object’s real class wins. C++ needs the word virtual. static, private, and fields are always compile-time. Extra overloads that exist only in the child are invisible through a parent variable.",
      howTo: [
        ...
        "C++ without the word virtual is compile time, even if the object is a child.",
      ],
      bullets: [
        "One name, many behaviours — like the word “play”.",
        ...
        "Fields, static, and private always follow the variable, not the object.",
      ],
      examples: [
        {
    ...
    System.out.print(x.f());
          ...
          steps: [
            ...
            },
            {
              ...
              why: "Runtime polymorphism reads the object, not the variable — like “play” on a stage vs a field.",
            },
            {
...
class Main {
  public static void main(String[] args) {
    ...
    System.out.print(p.n + " " + p.f());
          ...
          steps: [
            ...
            },
            {
              ...
              why: "Field access does not wait for the object. It follows the variable.",
            },
            {
    ...
    {
      heading: "What are access specifiers?",
      body: "Private is a diary under lock. Only you may open that diary. A classmate cannot flip the pages, even if they sit next to you. Public is a notice on the school board: anyone may read it. Protected is a family album: this class and its children may look (in Java the same package may look too).\n\nThe exam rule is simple. Name the specifier, then name who wants to touch the field. private: only this class. public: everyone. protected: this class and its children (Java also lets the same package in). If the place is not allowed, the program does not compile. Python uses a name convention (_hidden, __mangled). It is not a compiler lock. The exam still asks what Java/C++ would forbid.",
      howTo: [
        ...
        "A public getter is the legal door into a private field — the key to the diary.",
        "Python _x is a polite hint. Java private is a real lock.",
      ],
      bullets: [
        "private = diary under lock. Only this class.",
        "public = anyone. protected = family (and Java package).",
        "Child code cannot write parent.privateField.",
        "A public field is not encapsulated.",
      ...
      examples: [
        {
          ...
          steps: [
            { do: "x is private. Other classes may not write p.x.", why: "private is a diary under lock." },
            { do: "getX() is package/public enough to call. It runs inside P, so it may read x.", why: "The getter is the key." },
        ...
        },
        {
          ...
          steps: [
            { do: "protected allows the child to name k.", why: "That is the point of protected — a family album." },
            { do: "A stranger class still cannot write parent.k.", why: "protected is not public." },
            { do: "If k were private, the child method would not compile.", why: "private stops even family. The diary stays locked." },
...
print(p._P__m)`,
          steps: [
            {
              ...
              why: "A leading underscore is not a compiler lock. It is not a diary lock.",
            },
            {
    ...
    {
      heading: "What is IS-A vs HAS-A?",
      body: "A dog IS an animal. That is IS-A: the child is a kind of parent, like a surname that runs in the family. A car HAS an engine. That is HAS-A: the car keeps an engine inside, the way a bag holds a pencil box. The car is not an engine.\n\nIS-A means Child extends Parent. A Square is a Shape, so you may write Shape s = new Square(). HAS-A is a field. A Car has an Engine. Car does not extend Engine. You write Engine e inside Car. The trap is calling every “uses” relationship inheritance.",
      howTo: [
        ...
        "A dog IS an animal. A car HAS an engine. Do not mix the two pictures.",
      ],
      bullets: [
        "IS-A = inheritance (family surname). HAS-A = a field (pencil box in a bag).",
        "A dog IS an animal. A car HAS an engine.",
        "Square is a Shape. Car has an Engine.",
        "If Y ref = new X() compiles, it is IS-A.",
      ...
      examples: [
        {
          ...
          steps: [
            ...
            { do: "A car HAS an engine. Car is not an Engine.", why: "HAS-A is not inheritance." },
            { do: "Engine e = new Car() does not compile.", why: "Those types are not in an is-a line." },
            { do: "Car may hold Engine eng; and call eng.start().", why: "That is composition — a field inside the car." },
        ...
        },
        {
          ...
          steps: [
            ...
            { do: "Write class Car { Engine e; } instead.", why: "HAS-A keeps the types honest: a car HAS an engine." },
        ...
        },
        {
          ...
          steps: [
            { do: "C is a B, and B is an A, so C is an A.", why: "IS-A chains, like surnames down a family tree." },
          ...
          steps: [
            {
              ...
              why: "Inheritance lets a child sit where a parent was declared. A dog IS an animal.",
            },
            {
...
// Dog d3 = a1;       // compile error (needs a cast)`,
          steps: [
            ...
            },
            {
              ...
              why: "The cast is legal when IS-A holds at run time. A dog IS an animal, and this one really is a dog.",
            },
            {
    ...
    {
      heading: "What are constructors and super()?",
      body: "A class is a rubber stamp. new presses the stamp and a constructor runs to fill in the fresh object. The parent stamp must press first, then the child stamp — like writing the family surname before the child’s own first name.\n\nA constructor has the class name and no return type. It runs when you write new. In Java, if you write this(…) or super(…), that call must be the first statement. You cannot write both in the same constructor. You cannot put a print before super(). If you write neither, Java inserts super() with no arguments. this(…) jumps to a sibling constructor in the same class. That sibling is responsible for calling super (or another this that eventually calls super). The parent is always built before the rest of the child body. Prints therefore go parent first, then child. If the parent has no no-arg constructor, a child that relies on inserted super() does not compile.",
      howTo: [
      ...
      bullets: [
        "new presses the stamp. The constructor fills the new object.",
        ...
        "No parent no-arg constructor + inserted super() = compile error.",
        "Prints go parent first, then child.",
      ],
      examples: [
        {
    ...
    new Child();
          ...
          steps: [
            ...
            },
            {
              ...
              why: "The parent stamp must press before the child body runs.",
            },
            {
